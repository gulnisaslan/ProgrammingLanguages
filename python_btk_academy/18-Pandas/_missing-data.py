...
result = df.drop(["a","c","e","f","h"],axis=0)
...
result = df.dropna(thresh= 3) #enaz sayıda normal değer
...
result = df.fillna(value = ortalama())#ortalamanın içine df yazmaya gerek yok bu sürüm kaynaklıdır.
