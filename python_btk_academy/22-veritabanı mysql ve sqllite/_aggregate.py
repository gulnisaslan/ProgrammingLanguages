...
def getProductInfo():
     ...
     #  sql= "Select COUNT(*) From Products"
      #sql= "Select AVG(price) From Products"#fiyat ortalaması veriyor.
     #  sql= "Select SUM(price) From Products"#kayıtların fiyatlerın toplar.
     #  sql= "Select MAX(price) From Products"# en yüksek fiyatı bulur.
     #  sql= "Select MIN(price) From Products"#en düşük değeri bulur.
